...
public class CalculatorPage : ContentPage
{
    ...
    public CalculatorPage(CalculatorViewModel vm)
    {
        ...
        Button buttonPlusMinus = new Button { Text = "+/-", Command = vm.NegativeCommand, };
        ...
        Button buttonPercent = new Button { Text = "%", Command = vm.PercentageCommand,  };
